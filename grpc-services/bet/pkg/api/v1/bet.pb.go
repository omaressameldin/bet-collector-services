...
type Bet struct {
	...
	WinnerId             *wrappers.StringValue `protobuf:"bytes,6,opt,name=winner_id,json=winnerId,proto3" json:"winner_id,omitempty"`
	ExpiryDate           *timestamp.Timestamp  `protobuf:"bytes,7,opt,name=expiry_date,json=expiryDate,proto3" json:"expiry_date,omitempty"`
	CompletionDate       *timestamp.Timestamp  `protobuf:"bytes,8,opt,name=completion_date,json=completionDate,proto3" json:"completion_date,omitempty"`
...
func (m *Bet) GetWinnerId() *wrappers.StringValue {
	if m != nil {
		return m.WinnerId
	}
	return nil
...
type BetUpdate struct {
	...
	WinnerId             *wrappers.StringValue `protobuf:"bytes,4,opt,name=winner_id,json=winnerId,proto3" json:"winner_id,omitempty"`
	ExpiryDate           *timestamp.Timestamp  `protobuf:"bytes,5,opt,name=expiry_date,json=expiryDate,proto3" json:"expiry_date,omitempty"`
	CompletionDate       *timestamp.Timestamp  `protobuf:"bytes,6,opt,name=completion_date,json=completionDate,proto3" json:"completion_date,omitempty"`
...
func (m *BetUpdate) GetWinnerId() *wrappers.StringValue {
	if m != nil {
		return m.WinnerId
	}
	return nil
...
var fileDescriptor_8bffc34e5f5c53ed = []byte{
	...
	,
}
